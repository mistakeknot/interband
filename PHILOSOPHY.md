# interband Philosophy

## Purpose
Shared sideband protocol library for Interverse modules.

## North Star
Advance interband through small, testable changes aligned to its core mission: Shared sideband protocol library for Interverse modules.
